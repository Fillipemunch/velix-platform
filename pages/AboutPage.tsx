...
const AboutPage: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Manifesto Header Section - Forest Green with Ivory Text */}
      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        ...
        <section className="mb-40 flex justify-center py-12">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <h3 className="text-[#D6825C] font-black text-[10px] uppercase tracking-[0.5em] mb-3">
                {t.about.founderRole}
              </h3>
              
              <h2 className="text-[#1a2e26] text-5xl font-black mb-8 tracking-tighter uppercase">
                {t.about.founderName}
              </h2>
              ...
              <div className="px-6">
                <p className="text-gray-500 leading-relaxed text-xl italic font-medium">
                  "{t.about.founderBio}"
                </p>
              </div>
              ...
              <div className="mt-16 pt-12 border-t border-slate-50 w-full space-y-10">
                ...
                <div className="pt-8">
                  <span className="text-slate-200 font-mono text-[10px] tracking-[0.5em] uppercase font-black">
                    VELIX EXECUTIVE CORE • 2026
                  </span>
                </div>
              </div>
            </div>
        ...
        <motion.div 
          ...
          className="text-center pt-24 border-t border-[#1a2e26]/5"
        >
