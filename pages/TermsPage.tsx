...
import { ArrowLeft, FileText, CreditCard, AlertCircle } from 'lucide-react';
        ...
        <div className="space-y-16">
          <section className="bg-white p-10 md:p-12 rounded-2xl border border-[#2D5A4C]/5 shadow-sm">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h2 className="text-2xl font-black text-[#1A2E26] tracking-tight">{t.terms.section1Title}</h2>
            </div>
          ...
          <section className="bg-white p-10 md:p-12 rounded-2xl border border-[#2D5A4C]/5 shadow-sm">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h2 className="text-2xl font-black text-[#1A2E26] tracking-tight">{t.terms.section2Title}</h2>
            </div>
            <p className="text-[#1A2E26]/70 leading-relaxed font-medium text-lg">
