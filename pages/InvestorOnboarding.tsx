...
import { ArrowLeft, Camera, CheckCircle2, Mail, ShieldAlert } from 'lucide-react';

const InvestorOnboarding: React.FC = () => {
  const { t, addInvestor } = useApp();
